...
<figure>
    <video controls preload="metadata">
        <source src="{{ '/images/video/el-plano-galactico-radiofrecuencia-frente-a-luz-visible/01.mp4' | relative_url }}" type="video/mp4">
        Tu navegador no soporta videos.
    </video>
    <figcaption>Radiofrecuencia vs. Luz Visible</figcaption>
</figure>
